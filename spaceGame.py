...
score_value = 0
font = pygame.font.Font('Atma.ttf', 32)

textX = 10
textY = 10

# Game over text
over_font = pygame.font.Font('Atma.ttf', 64)
...
while running:
    ...
    pygame.display.update()  # update the screen for color, player etc
